...
{babel_cdn}
  ...
  <style>
    ...
    #cs-loading .logo-i{{width:36px;height:36px;background:#6366f1;border-radius:8px;display:-webkit-flex;display:flex;-webkit-align-items:center;align-items:center;-webkit-justify-content:center;justify-content:center;flex-shrink:0;}}
    #cs-error{{
...
<body>
  ...
  <div id="cs-loading">
    <div class="logo">
      <div class="logo-i"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width="20" height="20"><path d="M4,16 L12,9 L12,12 L20,12 L20,9 L28,16 L20,23 L20,20 L12,20 L12,23 Z" fill="white"/></svg></div>
      CastSlate
    </div>

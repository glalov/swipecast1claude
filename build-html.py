...
{babel_cdn}
  ...
  <style>
    ...
    #cs-intro-bg{{
      ...
      display:-webkit-flex;display:flex;-webkit-align-items:center;align-items:center;-webkit-justify-content:center;justify-content:center;
      -webkit-animation:cs-bg-down 1.6s linear 2.75s forwards;animation:cs-bg-down 1.6s linear 2.75s forwards;
    }}
    ...
    #cs-intro .cs-intro-hold{{
      ...
      display:-webkit-flex;display:flex;-webkit-align-items:center;align-items:center;-webkit-justify-content:center;justify-content:center;
      -webkit-animation:cs-mark-up 1.6s linear 2.75s forwards;animation:cs-mark-up 1.6s linear 2.75s forwards;
    }}
...
<body>
  <!-- Intro reveal — logo fades in & the cube spins, then the black curtain (#cs-intro-bg)
       ...
       away top-down (no fade, no movement) while revealing the site (~4.3s). The whole

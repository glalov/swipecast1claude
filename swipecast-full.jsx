...
const FAQ_CATEGORIES=[
  ...
  {id:"safety",label:"Safety & Trust",icon:"🛡️",blurb:"How we vet castings, protect talent, and handle reports.",items:[
    {q:"How do you vet casting directors and productions?",a:"Industry accounts go through a basic verification step before posting. We check name, company, and at least one verifiable production credit. Suspicious or unverifiable accounts can post but are flagged in the queue and reviewed before going live."},
    {q:"What if a casting feels off?",a:"Use the 'Report' link on any casting page. Reports go directly to the safety team and we review same-day. Castings that violate our standards are removed and posters are warned, suspended, or banned."},
    {q:"Can minors use SlateCue?",a:"Only with a parent or legal guardian managing the account. We require guardian verification and comply with COPPA and state child-performer laws. Minors' contact information is never displayed publicly."},
    {q:"Are you NDA-friendly?",a:"Yes. Casting posts can be marked confidential, in which case the project title and synopsis are hidden until a callback is offered. Talent who receive callbacks see the project details and can sign an NDA before continuing."},
    {q:"How do you protect against fake or scam castings?",a:"All paid casting posts are reviewed by a real human before going live. Anything that requests payment from talent, asks for personal financial information, or doesn't meet our standards for a legitimate production is rejected."},
    {q:"What about audition safety?",a:"All in-person callbacks must take place in a verified production office or studio. Talent are encouraged to bring a chaperone for any audition that feels off. Report any safety concern through the Inbox or the Contact page."}
  ]},
...
// PAGE: CASTING DETAIL
// ═══════════════════════════════════════════
function CastingDetailPage({casting,onBack,onNavigate,isLoggedIn,onRequireAuth,myProfile}){
  ...
  return(<div className="page" style={{maxWidth:920}}>
    <button className="btn-s btn-sm mb-20" onClick={onBack}>← Back to Castings</button>
...
function TalentProfile({talent,onBack,onNavigate,session,myProfile}){
  ...
  return(<div className="page">
    <button className="btn-s btn-sm mb-20" onClick={onBack}>← Back</button>
...
export default function App(){
  ...
  return(
    <div className="app"><style>{css}</style>
      ...
      {page==="casting-detail"&&viewingCasting&&<CastingDetailPage key={viewingCasting.id} casting={viewingCasting} isLoggedIn={isLoggedIn} onRequireAuth={requireAuth} myProfile={myProfile} onBack={()=>{setPage(prevPage==="home"?"home":"search");setViewingCasting(null);window.scrollTo(0,0);}} onNavigate={navigate}/>}

...
const BLOG_POSTS = [
  ...
  {id:2,title:"Why SwipeCast Costs a Third of What Other Casting Sites Charge",date:"Apr 5, 2026",category:"Talent Tips",excerpt:"Legacy casting sites charge actors $20–$30/month and still can't guarantee your submission gets seen. SwipeCast is $9.99/mo with a 7-day free trial — and every headshot is seen, Tinder-style.",readTime:"7 min"},
      ...
      {step===4&&<>
        ...
        <div style={{background:"var(--s2)",border:"1px solid var(--bdr)",borderRadius:12,padding:24,marginBottom:20}}>
          <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:16}}>
            ...
            <div style={{fontFamily:"'DM Sans',sans-serif",fontWeight:800,fontSize:32,color:"var(--acc)"}}>$9.99<span style={{fontSize:14,color:"var(--t2)",fontWeight:400}}>/mo</span></div>
          </div>
  ...
  return(<>
    ...
    <div style={{borderTop:"1px solid var(--bdr)",borderBottom:"1px solid var(--bdr)",padding:"28px 40px",background:"var(--s2)"}}>
      <div style={{maxWidth:1200,margin:"0 auto",textAlign:"center"}}>
        <p style={{fontSize:11,letterSpacing:1,textTransform:"uppercase",color:"var(--t3)",marginBottom:18,fontWeight:700}}>Talent trained at & working with</p>
        <div style={{display:"flex",justifyContent:"center",gap:"clamp(24px,5vw,64px)",alignItems:"center",flexWrap:"wrap",opacity:0.55}}>
          {["JUILLIARD","YALE DRAMA","NYU TISCH","RADA","GROUNDLINGS","STELLA ADLER","UCB","AMDA"].map(n=><span key={n} style={{fontFamily:"'DM Sans',sans-serif",fontWeight:800,fontSize:14,letterSpacing:1,color:"var(--t1)"}}>{n}</span>)}
        </div>
      </div>
    </div>
    ...
    <div style={{maxWidth:900,margin:"20px auto 60px",background:"linear-gradient(135deg,rgba(26,26,46,.06),rgba(26,26,46,.02))",border:"1px solid var(--bdr)",borderRadius:20,padding:"48px 44px",textAlign:"center"}}>
      <div style={{display:"inline-block",background:"var(--acc)",color:"#fff",fontSize:10,fontWeight:800,letterSpacing:1.5,padding:"4px 12px",borderRadius:100,marginBottom:16,fontFamily:"'DM Sans',sans-serif"}}>THE SWIPECAST GUARANTEE</div>
    ...
    <section style={{padding:"40px 40px 60px",maxWidth:800,margin:"0 auto"}}>
      ...
      <div style={{display:"flex",flexDirection:"column",gap:10}}>
        {[
          {q:"How much does SwipeCast cost for actors?",a:"$9.99/month with a 7-day free trial. Cancel anytime. No 'featured' upgrade, no per-submission fees, no hidden tiers — and cheaper than every other major casting site."},
          {q:"How is this different from Backstage or Casting Networks?",a:"On those platforms, your submission lands in a grid where a CD can scan 80 faces in 20 seconds. On SwipeCast, every submission is full-screen, one at a time, Tinder-style. CDs must decide on you individually. No one gets skipped."},

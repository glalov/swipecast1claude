...
.credits-list{max-width:720px;}
.credit-row{display:grid;grid-template-columns:64px 1fr 200px;column-gap:24px;align-items:start;padding:12px 0;border-bottom:1px solid var(--bdr);}
...
.credit-role{font-size:13px;color:var(--t2);margin-top:3px;}
.credit-meta{font-size:13px;color:var(--t3);}
@media(max-width:640px){.credit-row{grid-template-columns:52px 1fr;}.credit-meta{grid-column:2;font-size:12px;padding-top:1px;}}

...
function AuthGate({pending,onComplete,onNavigate,onCancel}){
  ...
  return(<div className="page" style={{maxWidth:960}}>
    <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:48,alignItems:"start",padding:"20px 0 60px"}}>
      {/* LEFT: Context panel showing what they're applying to */}
      <div style={{background:"var(--s1)",border:"1px solid var(--bdr)",borderRadius:16,padding:"32px 28px",position:"sticky",top:100}}>
        ...
        <h2 style={{fontSize:26,fontWeight:800,letterSpacing:-0.5,marginBottom:10,lineHeight:1.15}}>Start your 7-day free trial to apply.</h2>
        <p style={{color:"var(--t2)",fontSize:14,lineHeight:1.65,marginBottom:24}}>SlateCue is <strong style={{color:"var(--t1)"}}>$9.99/month</strong> for talent after a 7-day free trial. Cancel anytime. You only need an account so casting directors can review your headshot and contact you.</p>
      ...
      <div>
        ...
        {mode==="signup"?<>
          <h2 style={{fontSize:28,fontWeight:800,letterSpacing:-1,marginBottom:8}}>Start your 7-day free trial</h2>
          <p style={{color:"var(--t2)",fontSize:14,marginBottom:24}}>Takes about 60 seconds. No credit card required.</p>

          <div style={{display:"flex",flexDirection:"column",gap:10,marginBottom:20}}>
            <button className="btn-s" style={{width:"100%",justifyContent:"center",display:"flex",gap:10}} onClick={onComplete}>
          ...
          <button className="btn-p" style={{width:"100%",marginTop:8}} onClick={onComplete}>Create Account & Continue to Apply →</button>
          ...
          <div style={{display:"flex",flexDirection:"column",gap:10,marginBottom:20}}>
            <button className="btn-s" style={{width:"100%",justifyContent:"center",display:"flex",gap:10}} onClick={onComplete}><span>🔵</span> Continue with Google</button>
            <button className="btn-s" style={{width:"100%",justifyContent:"center",display:"flex",gap:10}} onClick={onComplete}><span></span> Continue with Apple</button>
          </div>
          ...
          <p style={{textAlign:"center",color:"var(--t3)",fontSize:12,marginTop:20}}>New to SlateCue? <span onClick={()=>setMode("signup")} style={{color:"var(--blu)",cursor:"pointer",textDecoration:"underline"}}>Start your 7-day free trial</span></p>
        </>}
...
function Landing({onNavigate,onViewCasting,castingsVersion=0,isLoggedIn=false,myProfile=null}){
  ...
  return(<>
    ...
    <section style={{padding:"40px 40px 60px",maxWidth:800,margin:"0 auto"}}>
      ...
      <div style={{display:"flex",flexDirection:"column",gap:10}}>
        {[
          {q:"How much does SlateCue cost for actors?",a:"$9.99/month with a 7-day free trial. Cancel anytime. No 'featured' upgrade, no per-submission fees, no hidden tiers — and cheaper than every other major casting site."},

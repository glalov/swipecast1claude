...
function AdminClassInvitations({session}){
  ...
  const sendInvitation=async()=>{
    ...
    try{
      const uid=session?.user?.id;
      const{error}=await window.sb.from("class_invitations").upsert({
      ...
      },{onConflict:"talent_user_id,class_id"});
      if(error)throw error;
      setFormMsg("✓ Invitation sent.");
      setSelectedTalent(null);setSelectedClass(null);setMessage("");
  ...
  return(<>
    ...
    <div className="card" style={{padding:24,marginBottom:32}}>
      ...
      <div style={{marginBottom:16}}>
        ...
        <textarea className="input" rows={3} placeholder={selectedTalent?`Hi ${talentFirst(selectedTalent)}, we think this class could be a strong fit for your profile. A casting director or teacher may be interested in collaborating.`:"Hi [Name], we think this class could be a strong fit for your profile."} value={message} onChange={e=>setMessage(e.target.value)} style={{width:"100%",boxSizing:"border-box",resize:"vertical",fontFamily:"inherit"}}/>
      </div>

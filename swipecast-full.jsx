...
function IDVerifiedBadge({size="sm"}){
  ...
  return(<span style={{position:"relative",display:"inline-flex",alignItems:"center",gap:3}}>
    ...
    >ⓘ</span>
    {show&&<span style={{position:"absolute",bottom:"calc(100% + 8px)",left:"50%",transform:"translateX(-50%)",background:"var(--s1)",border:"1px solid var(--bdr)",borderRadius:8,padding:"10px 14px",fontSize:11,color:"var(--t2)",lineHeight:1.55,width:300,zIndex:99,boxShadow:"0 4px 16px rgba(0,0,0,0.12)",pointerEvents:"none",textAlign:"left"}}>
      This casting creator has completed identity verification through a third-party provider. Identity verification does not guarantee the legitimacy, safety, conduct, payment, or quality of any project, person, company, audition, or communication. Always use your own judgment and report suspicious activity.
    </span>}
  </span>);
}

...
#root{flex:1 1 auto;display:flex;flex-direction:column;min-height:100vh;}
    ...
    <div className="page">
      ...
      <div style={{maxWidth:1020,margin:"0 auto 48px",padding:"0 20px 12px"}}>
        <div style={{display:"grid",gridTemplateColumns:"repeat(3,1fr)",gap:20,alignItems:"stretch"}}>
          ...
          {/* Actor Premium */}
          <div style={{...card,border:"2px solid var(--acc)",boxShadow:"0 8px 36px rgba(0,0,0,0.14)",transform:"translateY(-10px)"}}>
  ...
  return(
    <div style={{maxWidth:1240,margin:"0 auto",padding:"32px 24px 64px"}}>
      ...
      <div style={{marginBottom:28}}>
        ...
        <h1 style={{fontWeight:800,fontSize:30,letterSpacing:-0.8,color:"var(--t1)",marginBottom:6,margin:"0 0 6px"}}>Welcome back, {firstName}.</h1>

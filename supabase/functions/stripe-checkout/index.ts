...
const PLAN_PRICE: Record<string, number> = { monthly: 17.99, six_month: 79, yearly: 129 };
const PLAN_RENEWAL: Record<string, number> = { monthly: 17.99, six_month: 79, yearly: 129 };
